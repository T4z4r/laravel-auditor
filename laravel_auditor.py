...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝  ╚═══╝  ╚══════╝╚══════╝╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═════╝ ╚═╝   ╚═╝    ╚═════╝ ╚═╝  ╚═╝
                                    ...
                                    Laravel Security Auditor v{0}
                                   ================================
                                         by {1}

                    "Secure your Laravel applications with confidence"
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        # Add banner label at the top
        banner_label = QLabel()
        banner_label.setText("""
        <center>
        <h1 style='color: #007bff; margin: 10px;'>🔒 Laravel Auditor</h1>
        <p style='font-size: 12px; color: #666;'>Secure Laravel Application Scanner v{0} by {1}</p>
        </center>
        """.format(__version__, __author__))
        banner_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        banner_label.setStyleSheet("border-bottom: 2px solid #007bff; margin-bottom: 10px; padding: 10px;")
        self.setMenuWidget(banner_label)
